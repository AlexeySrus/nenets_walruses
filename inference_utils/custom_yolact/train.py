from data import *
from data.iMaterialistics import iMaterialisticFashionDataset
...
def train():
    ...
    dataset = iMaterialisticFashionDataset(
        root_path='/media/alexey/DataDisk/datasets/iMaterialistFashion/',
        for_train=True,
        augmentations=True
    )

    # dataset = DeepFashion2Dataset(
    #     '/media/alexey/DataDisk/datasets/DeepFashion2/train/'
    # )
    ...
    if args.validation_epoch > 0:
        ...
        val_dataset = iMaterialisticFashionDataset(
            root_path='/media/alexey/DataDisk/datasets/iMaterialistFashion/',
            for_train=False
        )

        # val_dataset = DeepFashion2Dataset(
        #     '/media/alexey/DataDisk/datasets/DeepFashion2/validation/'
        # )
