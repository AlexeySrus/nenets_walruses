...
dataset_base = Config({
    ...
    'train_images': '/media/alexey/SSDDataDisk/datasets/walruses/coco/images/',
    'train_info': '/media/alexey/SSDDataDisk/datasets/walruses/coco/annotations/instances_train2017.json',

    # Validation images and annotations.
    'valid_images': '/media/alexey/SSDDataDisk/datasets/walruses/coco/images/',
    'valid_info': '/media/alexey/SSDDataDisk/datasets/walruses/coco/annotations/instances_val2017.json',
...
darknet53_backbone = backbone_base.copy({
    ...
    'pred_scales': [[3.5, 4.95], [3.6, 4.90], [3.3, 4.02], [2.7, 3.10],
                    [2.1, 2.37], [1.8, 1.92]],
    'pred_aspect_ratios': [
        [[1, sqrt(2), 1 / sqrt(2), sqrt(3), 1 / sqrt(3)][:n], [1]] for n in
        [3, 5, 5, 5, 3, 3]],
})
...
vgg16_arch = [[64, 64],
              ['M', 128, 128],
              ['M', 256, 256, 256],
              [('M', {'kernel_size': 2, 'stride': 2, 'ceil_mode': True}), 512,
               512, 512],
              ['M', 512, 512, 512],
...
vgg16_backbone = backbone_base.copy({
    ...
    'pred_scales': [[5, 4]] * 6,
    'pred_aspect_ratios': [
        [[1], [1, sqrt(2), 1 / sqrt(2), sqrt(3), 1 / sqrt(3)][:n]] for n in
        [3, 5, 5, 5, 3, 3]],
})
...
yolact_base_config = coco_base_config.copy({
    ...
    'backbone': resnet101_backbone.copy({
        ...
        # This is for backward compatability with a bug
...
yolact_plus_base_config = yolact_base_config.copy({
    ...
    'backbone': resnet101_dcn_inter3_backbone.copy({
        ...
        'pred_aspect_ratios': [[[1, 1 / 2, 2]]] * 5,
        'pred_scales': [[i * 2 ** (j / 3.0) for j in range(3)] for i in
                        [24, 48, 96, 192, 384]],
        'use_pixel_scales': True,
        'preapply_sqrt': False,
        'use_square_anchors': False,
    ...
    'use_maskiou': True,
    'maskiou_net': [(8, 3, {'stride': 2}), (16, 3, {'stride': 2}),
